...
public:
	...
	static string GetTimeString(int64_t time,int nType=0);
	//查询
	static string SearchTime();
	//查询积分
	static string SearchJiFen(int64_t fromGroup, int64_t fromQQ,int64_t sendTime);
	//操作
	...
	//获取连续签到天数
	static int GetSingedDays(int64_t fromGroup, int64_t fromQQ,int64_t sendTime);
	//设置连续签到数
	static void SetSingedDays(int nDays,int64_t fromGroup, int64_t fromQQ,int64_t sendTime);
	//得到邀请积分
